...
class SpiderConnection {
	...
	/**
	 * Connection to get response headers. Cause Jsoup only support a few mount
	 * of <code>MINE</code> type, but I want to get all contents' response
	 * headers
	 */
